...
with open(argv[1], 'r') as file:
    ...
    with open("r2_comparation_paris_agreement/ajuste_1958_2025_quadratico.csv", "w") as out_file:
    ...
    with open("predictions_paris_agreement/previsoes_2025_2050_quadratica.csv", "w") as out_file:
