...
with open(argv[1], 'r') as file:
    ...
    with open("r2_comparation_paris_agreement/ajuste_2016_2025_logaritmico.csv", "w") as out_file:
    ...
    with open("predictions_paris_agreement/previsoes_2025_2035_logaritmica.csv", "w") as out_file:
    ...
    plt.savefig("graphics_paris_agreement/ajuste_logaritmico.png", dpi=300, bbox_inches='tight')
    plt.show()