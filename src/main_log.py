...
with open(argv[1], 'r') as file:
    ...
    with open("r2_comparation_paris_agreement/ajuste_2016_2025_logaritmicov2.csv", "w") as out_file:
    ...
    with open("predictions_paris_agreement/previsoes_2025_2035_logaritmicav2.csv", "w") as out_file:
    ...
    plt.savefig("graphics_paris_agreement/ajuste_logaritmicov2.png", dpi=300, bbox_inches='tight')
    plt.show()